...
import { Cpu, Bell, Calendar, Flame, Sparkles, ShieldCheck, LogIn, LogOut, User as UserIcon } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-3 text-xs">
          ...
          {user ? (
            ...
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-gray-950 font-bold rounded-xl flex items-center gap-1.5 shadow-md shadow-cyan-500/20 transition-all cursor-pointer"
            >
      ...
      <footer className="glass-card p-6 border border-gray-800 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400 mt-8">
        <div className="flex items-center gap-3">
